...
from monkeyplug.monkeyplug import WhisperPlugger, DEFAULT_WHISPER_MODEL_DIR, DEFAULT_WHISPER_MODEL_NAME, CONFIDENCE_THRESHOLD_DEFAULT

REMOTE_WHISPER_URL = "http://whisper.x86experts.com:8001"
...
class MockPlugger:
    ...
    def __init__(self, swearsFileSpec, inputTranscript=None, debug=False):
        ...
        self.debug = debug
        self.wordList = []
        self.confidenceThreshold = CONFIDENCE_THRESHOLD_DEFAULT
